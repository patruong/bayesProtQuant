...
def comparisonPlot(sampgroup, specie, hardRange = True, truncated = False, title = "plot"):
    ...
    fig.savefig("NEW_"+specie+ "_" + title+".png")
...
def main_singleImpute(impute_method = "min", truncated = False, triqlerExponential = 2, global_impute = True, maxNaN = 6,
    ...
    comparisonPlot(sampgroup, "H sapeins",  hardRange = False, truncated = truncated)
    comparisonPlot(sampgroup, "C elegans",  hardRange = False, truncated = truncated)
    comparisonPlot(sampgroup, "A thaliana",  hardRange = False, truncated = truncated)
...
if __name__ == "__main__":
    ...
    #main_singleImpute(impute_method="min", triqlerExponential = 2, global_impute = True, 
    #                  PSSS3Input = "500-PSSS3-raw-reformatted_dropna_dropdup_decoy_nonShared.csv",
    #                triqlerInput = "proteins.1vs2.tsv")
    #main_singleImpute(impute_method= None, triqlerExponential = False, global_impute = True, 
    #                  PSSS3Input = "500-PSSS3-raw-reformatted_dropna_dropdup_decoy_sharedCAEEL.csv",
    #                triqlerInput = "proteins.1vs2.tsv")
    #main_singleImpute(impute_method= None, truncated = ["S02", "S03", "S04", "S05"] , triqlerExponential = False, global_impute = True, 
    #              PSSS3Input = "500-PSSS3-raw-reformatted_dropna_dropdup_decoy_nonShared_again.csv",
    #            triqlerInput = "proteins.1vs2.tsv")
    main_singleImpute(impute_method= None, truncated = False , triqlerExponential = False, global_impute = True, maxNaN = 6,
                  PSSS3Input = "500-PSSS3-raw-reformatted_dropna_dropdup_decoy_nonShared_again.csv",
                triqlerInput = "triqlerOutput_minSamp30_protPriorNaN/proteins.1vs2.tsv")
    #mainMultiImpute(triqlerExponential = 2,
    #                PSSS3Input = "500-PSSS3-raw-reformatted_dropna_dropdup_decoy.csv",
    #                triqlerInput = "proteins.1vs2.tsv")
    #mainDiffExp(fileDir, PSSS3Input, impute_method = None, global_impute = True, figName = "plot")

    #main_singleImpute(impute_method = None, truncated = ["S01","S02"], triqlerExponential = False, global_impute = True, PSSS3Input = "500-PSSS3-raw-reformatted_dropna_dropdup_decoy_nonShared_again.csv", triqlerInput = "PSSS3_subset/S01_S02/proteins.tsv")
